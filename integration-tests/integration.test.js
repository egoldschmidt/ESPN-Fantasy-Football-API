...
describe('client integration tests', () => {
  ...
  describe('getPlayerSeason', () => {
    ...
    test('returns stats for a player for 2020', async () => {
      ...
      // didn't play Week 3 2020 @ New Orleans
      expect(playerSeason.weeklyActual[3].points.totalPoints).toEqual(0);
    ...
    test('returns stats for a player for 2019', async () => {
      ...
      // didn't play Week 5 2019 @ Dallas
      expect(playerSeason.weeklyActual[5].points.totalPoints).toEqual(0);
    ...
    test('returns stats for a player for 2018', async () => {
      ...
      // bye week
      expect(playerSeason.weeklyActual[7]).toEqual(undefined);
      // didn't play Week 17 vs. Detroit
      expect(playerSeason.weeklyActual[17].points.totalPoints).toEqual(0);
